        ...
        return r.each(function (p) {
            ...
            w = {
                initialize: function () {
                    ...
                    t = e.isFunction(t) ? t : function () {
                    }, w.is.active() && (w.debug("Hiding dropdown"), k.onHide.call($) !== !1 && w.animate.hide(function () {
        ...
        return r.each(function () {
            ...
            S = {
                initialize: function () {
                    ...
                    t = e.isFunction(t) ? t : function () {
                    }, S.debug("Hiding modal"), T.onHide.call(z), (S.is.animating() || S.is.active()) && (T.transition && e.fn.transition !== i && O.transition("is supported") ? (S.remove.active(), O.transition({
                        debug: T.debug,
