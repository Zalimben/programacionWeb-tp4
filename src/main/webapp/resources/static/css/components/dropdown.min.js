            ...
            b = {
                initialize: function () {
                    ...
                    layout: function () {
                        ...
                        var e, t, n = r.index(E);
                        b.debug("Dropdown behavior was called on select, replacing with closest dropdown"), E = E.parent(C.dropdown), b.refresh(), e = r.slice(0, n), t = r.slice(n + 1), r = e.add(E).add(t), v && (R = b, b.invoke(f))
                    }
                }, refresh: function () {
                    ...
                    mousedown: function () {
                        ...
                        var t = n.activeElement === this;
                        z || t || (w.forceSelection ? b.forceSelection() : b.hide())
