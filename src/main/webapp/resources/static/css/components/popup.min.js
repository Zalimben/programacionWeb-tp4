        ...
        return s.each(function () {
            ...
            b = {
                initialize: function () {
                    ...
                    start: function (t) {
                        var o = e.isPlainObject(v.delay) ? v.delay.show : v.delay;
                    ...
                    position: function (i, r) {
                        ...
                        if (p === n && b.error(P.invalidPosition, i), b.debug("Calculated popup positioning values", p), o.css(p).removeClass(w.position).addClass(i).addClass(w.loading), l = b.get.offstagePosition(i)) {
                            ...
                            if (!v.lastResort)return b.debug("Popup could not find a position in view", o), b.remove.attempts(), b.remove.loading(), b.reset(), !1
                        }
