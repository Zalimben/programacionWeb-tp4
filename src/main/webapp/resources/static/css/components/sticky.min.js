...
!function (e, t, o, n) {
    ...
    e.fn.sticky = function (o) {
        var i, s = e(this), c = s.selector || "", r = (new Date).getTime(), a = [], l = arguments[0], f = "string" == typeof l, m = [].slice.call(arguments, 1);
            ...
            d = {
                initialize: function () {
                    ...
                    direction: function (e) {
                        ...
                        e = e || k.scrollTop();
                        var t, o = d.cache.element, n = d.cache.window, i = d.get.scrollChange(e), s = o.height - n.height + h.offset, t = d.get.currentElementScroll(), c = t + i;
                    ...
                    offset: function () {
                        ...
                        "HTML" === e || "body" == e ? S = C.offsetParent() : Math.abs(S.height() - d.cache.context.height) > 5 && (d.debug("Context has padding, specifying exact height for container", d.cache.context.height), S.css({height: d.cache.context.height}))
                    }, scroll: function (e) {
                    ...
                    var t = e || k.scrollTop(), o = d.cache, n = o.fits, i = o.element, s = o.window, c = o.context, r = d.is.bottom() && h.pushing ? h.bottomOffset : h.offset, e = {
                        top: t + r,
                        bottom: t + r + s.height
                    }, a = (d.get.direction(e.top), n ? 0 : d.get.elementScroll(e.top)), l = !n, f = 0 !== i.height;
                    ...
                    var c, r, a, l = w;
                    return o = o || m, s = P || s, "string" == typeof t && l !== n && (t = t.split(/[\. ]/), c = t.length - 1, e.each(t, function (o, i) {
