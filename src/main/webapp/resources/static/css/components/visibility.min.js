...
!function (e, o, t, n) {
    ...
    e.fn.visibility = function (i) {
        ...
        return c.each(function () {
            var c, b, g = e.isPlainObject(i) ? e.extend(!0, {}, e.fn.visibility.settings, i) : e.extend({}, e.fn.visibility.settings), f = g.className, p = g.namespace, v = g.error, h = "." + p, P = "module-" + p, V = e(o), C = e(this), y = e(g.context), R = (C.selector || "", C.data(P)), x = o.requestAnimationFrame || o.mozRequestAnimationFrame || o.webkitRequestAnimationFrame || o.msRequestAnimationFrame || function (e) {
                    setTimeout(e, 0)
                }, T = this;
            b = {
                initialize: function () {
                    ...
                    y[0];
                    "MutationObserver"in o && (c = new MutationObserver(function (e) {
                    ...
                    events: function () {
                        ...
                        var o = C.find("img"), n = o.length, i = n, s = 0, c = [], r = [], a = t.createElement("img"), l = function () {
                    ...
                    for (var i = o.length, s = 0, c = [], r = t.createElement("img"), a = function () {
                    ...
                    image: function (o) {
                        var t = b.cache.screen.bottom < b.cache.element.top;
                        C.attr("src", o), t ? (b.verbose("Image outside browser, no show animation"), C.show()) : g.transition ? e.fn.transition !== n ? C.transition(g.transition, g.duration) : C.fadeIn(g.duration) : C.show()
                    }
                }, is: {
                    visible: function () {
                    ...
                    if (o !== n && t !== n)g.onPassed[o] = t; else {
                        if (o !== n)return b.get.pixelsPassed(o) > i.pixelsPassed;
                    ...
                    var o = b.get.elementCalculations(), t = e || g.onPassing, i = "passing";
                    return e && (b.debug("Adding callback for passing", e), g.onPassing = e), o.passing ? b.execute(t, i) : g.once || b.remove.occurred(i), e !== n ? o.passing : void 0
                }, topVisible: function (e) {
                    var o = b.get.elementCalculations(), t = e || g.onTopVisible, i = "topVisible";
                    return e && (b.debug("Adding callback for top visible", e), g.onTopVisible = e), o.topVisible ? b.execute(t, i) : g.once || b.remove.occurred(i), e === n ? o.topVisible : void 0
                }, bottomVisible: function (e) {
                    var o = b.get.elementCalculations(), t = e || g.onBottomVisible, i = "bottomVisible";
                    return e && (b.debug("Adding callback for bottom visible", e), g.onBottomVisible = e), o.bottomVisible ? b.execute(t, i) : g.once || b.remove.occurred(i), e === n ? o.bottomVisible : void 0
                }, topPassed: function (e) {
                    var o = b.get.elementCalculations(), t = e || g.onTopPassed, i = "topPassed";
                    return e && (b.debug("Adding callback for top passed", e), g.onTopPassed = e), o.topPassed ? b.execute(t, i) : g.once || b.remove.occurred(i), e === n ? o.topPassed : void 0
                }, bottomPassed: function (e) {
                    var o = b.get.elementCalculations(), t = e || g.onBottomPassed, i = "bottomPassed";
                    return e && (b.debug("Adding callback for bottom passed", e), g.onBottomPassed = e), o.bottomPassed ? b.execute(t, i) : g.once || b.remove.occurred(i), e === n ? o.bottomPassed : void 0
                }, passingReverse: function (e) {
                    var o = b.get.elementCalculations(), t = e || g.onPassingReverse, i = "passingReverse";
                    return e && (b.debug("Adding callback for passing reverse", e), g.onPassingReverse = e), o.passing ? g.once || b.remove.occurred(i) : b.get.occurred("passing") && b.execute(t, i), e !== n ? !o.passing : void 0
                }, topVisibleReverse: function (e) {
                    var o = b.get.elementCalculations(), t = e || g.onTopVisibleReverse, i = "topVisibleReverse";
                    return e && (b.debug("Adding callback for top visible reverse", e), g.onTopVisibleReverse = e), o.topVisible ? g.once || b.remove.occurred(i) : b.get.occurred("topVisible") && b.execute(t, i), e === n ? !o.topVisible : void 0
                }, bottomVisibleReverse: function (e) {
                    var o = b.get.elementCalculations(), t = e || g.onBottomVisibleReverse, i = "bottomVisibleReverse";
                    return e && (b.debug("Adding callback for bottom visible reverse", e), g.onBottomVisibleReverse = e), o.bottomVisible ? g.once || b.remove.occurred(i) : b.get.occurred("bottomVisible") && b.execute(t, i), e === n ? !o.bottomVisible : void 0
                }, topPassedReverse: function (e) {
                    var o = b.get.elementCalculations(), t = e || g.onTopPassedReverse, i = "topPassedReverse";
                    return e && (b.debug("Adding callback for top passed reverse", e), g.onTopPassedReverse = e), o.topPassed ? g.once || b.remove.occurred(i) : b.get.occurred("topPassed") && b.execute(t, i), e === n ? !o.onTopPassed : void 0
                }, bottomPassedReverse: function (e) {
                    var o = b.get.elementCalculations(), t = e || g.onBottomPassedReverse, i = "bottomPassedReverse";
                    return e && (b.debug("Adding callback for bottom passed reverse", e), g.onBottomPassedReverse = e), o.bottomPassed ? g.once || b.remove.occurred(i) : b.get.occurred("bottomPassed") && b.execute(t, i), e === n ? !o.bottomPassed : void 0
                }, execute: function (e, o) {
                    var t = b.get.elementCalculations(), n = b.get.screenCalculations();
                    e = e || !1, e && (g.continuous ? (b.debug("Callback being called continuously", o, t), e.call(T, t, n)) : b.get.occurred(o) || (b.debug("Conditions met", o, t), e.call(T, t, n))), b.save.occurred(o)
                }, remove: {
                    occurred: function (e) {
                    ...
                    calculations: function () {
                        ...
                        var e, o = b.get.scroll(), t = b.get.lastScroll();
                        return e = o > t && t ? "down" : t > o && t ? "up" : "static", b.cache.direction = e, b.cache.direction
                    }, elementPosition: function () {
                        var e = b.cache.element, o = b.get.screenSize();
                        return b.verbose("Saving element position"), e.fits = e.height < o.height, e.offset = C.offset(), e.width = C.outerWidth(), e.height = C.outerHeight(), b.cache.element = e, e
                    }, elementCalculations: function () {
                        var e = b.get.screenCalculations(), o = b.get.elementPosition();
                        return g.includeMargin ? (o.margin = {}, o.margin.top = parseInt(C.css("margin-top"), 10), o.margin.bottom = parseInt(C.css("margin-bottom"), 10), o.top = o.offset.top - o.margin.top, o.bottom = o.offset.top + o.height + o.margin.bottom) : (o.top = o.offset.top, o.bottom = o.offset.top + o.height), o.topVisible = e.bottom >= o.top, o.topPassed = e.top >= o.top, o.bottomVisible = e.bottom >= o.bottom, o.bottomPassed = e.top >= o.bottom, o.pixelsPassed = 0, o.percentagePassed = 0, o.visible = o.topVisible || o.bottomVisible, o.passing = o.topPassed && !o.bottomPassed, o.hidden = !o.topVisible && !o.bottomVisible, o.passing && (o.pixelsPassed = e.top - o.top, o.percentagePassed = (e.top - o.top) / o.height), b.cache.element = o, b.verbose("Updated element calculations", o), o
                    ...
                    log: function (e) {
                        var o, t, n;
                        g.performance && (o = (new Date).getTime(), n = a || o, t = o - n, a = o, l.push({
                            Name: e[0],
                        ...
                        var o = g.name + ":", t = 0;
                        a = !1, clearTimeout(b.performance.timer), e.each(l, function (e, o) {
                            t += o["Execution Time"]
                    ...
                    var c, r, a, l = R;
                    return t = t || m, i = T || i, "string" == typeof o && l !== n && (o = o.split(/[\. ]/), c = o.length - 1, e.each(o, function (t, i) {
                        var s = t != c ? i + o[t + 1].charAt(0).toUpperCase() + o[t + 1].slice(1) : o;
                        if (e.isPlainObject(l[s]) && t != c)l = l[s]; else {
                            if (l[s] !== n)return r = l[s], !1;
                            if (!e.isPlainObject(l[i]) || t == c)return l[i] !== n ? (r = l[i], !1) : (b.error(v.method, o), !1);
                            l = l[i]
                        }
